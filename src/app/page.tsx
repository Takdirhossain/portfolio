...
import { FaArrowDown, FaYoutube, FaFacebook, FaLinkedin, FaInstagram, FaTwitter, FaGithub, FaReddit, FaCertificate, FaChevronRight, FaLink   } from 'react-icons/fa';
    ...
    <main className="min-h-screen flex flex-col">
              ...
              >
                {personalInfo.title.split('|').map((item, index) => (
                  <motion.span
                    ...
                    className={`px-4 py-2 rounded-full text-sm backdrop-blur-sm transition-all duration-300 cursor-pointer ${index === 0 ? 'bg-primary/10 text-primary dark:bg-[#4285f4]/20 dark:text-[#a1b1f7] dark:border dark:border-[#4285f4]/30' :
              ...
              <div className="w-full max-w-lg relative">
                ...
                <div className="rounded-lg overflow-hidden border border-primary/30 dark:border-[#1e2c5f] shadow-2xl max-w-full">
                  ...
                  <div className="bg-gray-100 dark:bg-[#1c233d] px-4 py-2 flex items-center">
                    ...
                    <span className="text-gray-600 dark:text-[#9aa3bc] text-xs md:text-sm">profile.js</span>
                  </div>
                  ...
                  <div className="bg-white dark:bg-[#0d1117] p-3 md:p-6 font-mono text-xs md:text-sm text-gray-700 dark:text-[#9aa3bc] overflow-auto max-h-[350px] md:max-h-none">
                    <div className="whitespace-pre-wrap break-words">
                      ...
                      <br />
                      <span className="ml-4 text-red-500 dark:text-[#e06c75]">title</span><span className="text-gray-800 dark:text-white">:</span> <span className="text-green-600 dark:text-[#98c379]">'Software Engineer'</span><span className="text-gray-800 dark:text-white">,</span>
                      <br />
                      ...
                      <span className="ml-8 text-green-600 dark:text-[#98c379]">'React'</span><span className="text-gray-800 dark:text-white">,</span> <span className="text-green-600 dark:text-[#98c379]">'Angular'</span><span className="text-gray-800 dark:text-white">,</span>
                      <span className="ml-8 text-green-600 dark:text-[#98c379]">'Node.js'</span><span className="text-gray-800 dark:text-white">,</span> <span className="text-green-600 dark:text-[#98c379]">'Laravel'</span><span className="text-gray-800 dark:text-white">,</span>
                      <br />
      ...
      <section className="py-24 bg-white dark:bg-gray-900">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4  max-w-5xl mx-auto border-l-[1px] border-gray-200 dark:border-gray-700 border-t-[1px] ">
            {[
              ...
              { name: "NextJS", icon: "/assets/icons/skills/nextjs-icon.svg", level: "40%" },
              { name: "React", icon: "/assets/icons/skills/react.svg", level: "40%" },
              { name: "Angular", icon: "/assets/icons/skills/programing.png", level: "20%" },
              { name: "VueJS", icon: "/assets/icons/skills/document.png", level: "30%" },
              { name: "ExpressJS", icon: "/assets/icons/skills/express.png", level: "30%" },
              { name: "Laravel", icon: "/assets/icons/skills/laravel.png", level: "10%" },
              { name: "NodeJS", icon: "/assets/icons/skills/nodejs-icon.svg", level: "10%" },
              { name: "Git", icon: "/assets/icons/skills/git.svg", level: "55%" },
              { name: "Ubuntu", icon: "/assets/icons/skills/ubuntu.png", level: "50%" },
            ].map((skill, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 20 }}
                ...
                className="group"
              >
                <div className="flex cursor-pointer border-r-[1px] border-gray-200 border-b-[1px] flex-col items-center p-6   dark:border-gray-700 bg-gray-50 dark:bg-gray-900 hover:border-primary/50 dark:hover:border-primary/50 transition-all duration-300 h-full">
                  ...
                  {[
                    {
                      ...
                      description: "Crafting responsive frontends and robust backends using React, Angular, Laravel, and Vue for seamless user experiences..",
                      icon: "💻"
                    },
                    {
                      title: "System Architecture & Server Management",
                      description: "Designing and managing scalable systems with Nginx and Ubuntu VPS to ensure high-performance applications.",
                      icon: "🔒"
                    },
                    {
                      title: "Project Leadership & Innovation",
                      description: "Leading international projects like ICT Olympiad Bangladesh to deliver innovative, client-focused solutions.",
                      icon: "📹"
                    }
                  ].map((item, index) => (
                    <motion.div
            ...
            {[
              ...
              >
                <div className="p-6 flex flex-col items-center text-center">
                  <div className={`p-3 rounded-full mb-4 ${feature.color === "primary" ? "text-primary bg-primary/10" :
                  ...
                  <Link href={feature.link}>
                    <motion.button
                      className={`px-4 py-2 rounded-md text-white ${feature.color === "primary" ? "bg-primary hover:bg-primary/90" :
